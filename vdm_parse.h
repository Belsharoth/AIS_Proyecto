...
int ais_binary_encode_1(aismsg_1 *ais, char *message, int flag);
/*int ais_binary_encode_2(aismsg_2 *ais, char *message, int flag);
int ais_binary_encode_3(aismsg_3 *ais, char *message, int flag);
int ais_binary_encode_4(aismsg_4 *ais, char *message, int flag);
int ais_binary_encode_5(aismsg_5 *ais, char *message, int flag);*/
